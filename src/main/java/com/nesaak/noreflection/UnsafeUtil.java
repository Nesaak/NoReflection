...
public class UnsafeUtil {
    ...
    private static final Method DEFINE_ANONYMOUS_METHOD;
    private static final Method ALLOCATE_METHOD;
    ...
    static {
        try {
            ...
            DEFINE_ANONYMOUS_METHOD = UNSAFE_CLASS.getDeclaredMethod("defineAnonymousClass", Class.class, byte[].class, Object[].class);
            ALLOCATE_METHOD = UNSAFE_CLASS.getDeclaredMethod("allocateInstance", Class.class);
    ...
    public static void putField(Field field, Object object, Object value) {
        long offset = (long) FIELD_OFFSET.call(UNSAFE, field);
